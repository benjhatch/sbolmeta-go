...
function summarizeGenericTopLevel(genericTopLevel) {
    ...
    return {
        ...
        wasDerivedFroms: wasDerivedFroms(genericTopLevel),
...
function wasDerivedFroms(genericTopLevel) {

    return genericTopLevel.wasDerivedFroms
...
function source(genericTopLevel) {
